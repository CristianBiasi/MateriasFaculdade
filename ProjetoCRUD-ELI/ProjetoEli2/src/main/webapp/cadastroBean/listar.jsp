...
<body>
    <div class="container">
        ...
        <a href="formulario.jsp?idproduto=0" class="btn btn-primary mt-3">Novo Produto</a>
            ...
            <tbody>
                <%
                    ...
                    for (Produto p : dao.listar()) {
                        ...
                        out.print("<td>");
                        out.print("<a href='formulario.jsp?idproduto=" + p.getIdproduto() + "' class='btn btn-warning btn-sm'>Alterar</a> ");
                        out.print("<a href='excluir.jsp?idproduto=" + p.getIdproduto() + "' class='btn btn-danger btn-sm'>Excluir</a>");
                        out.print("</td>");
                        out.print("</tr>");
                    }
                %>
